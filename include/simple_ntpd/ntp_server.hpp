...
struct NtpServerStats {
    ...
    NtpServerStats() : total_connections(0), active_connections(0),
...
public:
     ...
     */
    NtpServer(std::shared_ptr<NtpConfig> config,
...
private:
     ...
     */
    void handleNewConnection(socket_t client_socket, const std::string& client_address);

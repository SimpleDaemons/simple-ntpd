/**
 * @file ntp_connection.hpp
 * @brief NTP connection management class
...
struct NtpConnectionStats {
  ...
  NtpConnectionStats()
      : packets_received(0), packets_sent(0), bytes_received(0), bytes_sent(0),
        errors(0) {}
};
...
public:
   ...
   */
  NtpConnection(socket_t socket, const std::string &client_address,

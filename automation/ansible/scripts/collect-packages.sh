...
REMOTE_PROJECT_DIR="/opt/simple-ntpd"
...
- name: Collect packages from remote VMs
  ...
  vars:
    ...
    remote_dist_dir: "/opt/simple-ntpd/dist"
    remote_build_dir: "/opt/simple-ntpd/build"
    remote_centralized_dir: "/opt/simple-ntpd/dist/centralized/v$VERSION"
